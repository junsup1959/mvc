...
<body>
	<div class="content">
		...
		<div class="topcont">
			<div class="recomment">
				<ul>
					<li style="font-size: 10px;">문의하시기 전 FAQ를 확인하시면 궁금증을 더욱 빠르게 해결하실 수 있습니다.</li>
				</ul>
			</div>
		...
		<dl style="border: ">
		<dt>
		<span><input type="checkbox" id="chk"><label><strong>개인정보 수집에 대한 동의</strong></label></span>
		<span>[필수]</span>
		</dt>
		</dl>
		...
		<div style="margin-top: 50px;">* 원활한 서비스 이용을 위한 최소한의 개인정보이므로 동의하지 않을 경우 서비스를 이용하실 수 없습니다</div>
		<form method="post">
			<table>
				<tr>
					<td>문의지점</td>
